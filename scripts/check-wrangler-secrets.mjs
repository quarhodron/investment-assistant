...
//   - ENCRYPTION_KEY value embedded as a literal
...
if (/["']?ENCRYPTION_KEY["']?\s*[:=]\s*["'][^"']+["']/.test(src)) {
  failures.push("ENCRYPTION_KEY value found in wrangler.jsonc — use `wrangler secret put`.");
}
